...
import com.vvsoftdev.to_dotask.sync.ToDoReminderFirebaseJobService;
...
public class ReminderUtils {
    ...
    //  - REMINDER_JOB_TAG should be a String constant, storing something like "todo_reminder_tag"
    ...
    private static final String REMINDER_JOB_TAG = "todo_task_reminder_tag";

    private static boolean sInitialized;
    static FirebaseJobDispatcher dispatcher;

    //  Create a synchronized, public static method called scheduleToDoTaskReminder that takes
    // in a context. This method will use FirebaseJobDispatcher to schedule a job that repeats roughly
    // every REMINDER_INTERVAL_SECONDS when the phone is charging. It will trigger ToDoReminderFirebaseJobService
    // Checkout https://github.com/firebase/firebase-jobdispatcher-android for an example
    synchronized public static void scheduleToDoTaskReminder(@NonNull final Context context) {
        ...
        // - has ToDoReminderFirebaseJobService as it's service
